...
namespace FlightTicket.Web.Controllers
{
    public class FlightTicketController : Controller
    {
        ...
        public FlightTicketController(ITripService ITripService, ICustomerService customerService, ITicketService ticketService, ILineService lineService)
        {
        ...
        public async Task<IActionResult> PassangerDetails(PassangerDetailsModel passangerDetails)
        {
            ...
            request.CallbackUrl = $"https://localhost:7104/FlightTicket/DisplayTicket?customerId={customer.Id.ToString()}&tripId={passangerDetails.TripId}&selectedSeatNo={passangerDetails.SelectedSeatNo}";
            ...
            firstBasketItem.Category1 = "FlightTicket";
