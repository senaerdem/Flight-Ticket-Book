        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TripDetail_Flight_FlightId",
                        column: x => x.FlightId,
                        principalTable: "Flight",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripDetail_Company_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Company",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TripDetail_Driver_DriverId",
                        column: x => x.DriverId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MidLineOrder = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MidLine", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MidLine_Line_LineId",
                        column: x => x.LineId,
                        principalTable: "Line",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trip_MidLine_MidLineId",
                        column: x => x.MidLineId,
                        principalTable: "MidLine",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trip_TripDetail_TripDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trip_MidLineId",
                table: "Trip",
                column: "MidLineId");

            migrationBuilder.CreateIndex(
                name: "IX_Trip_TripDetailId",
                table: "Trip",
                column: "TripDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_TripDetail_FlightId",
                table: "TripDetail",
                column: "FlightId");

            migrationBuilder.CreateIndex(
                name: "IX_TripDetail_CompanyId",
                table: "TripDetail",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_TripDetail_DriverId",
                table: "TripDetail",
                column: "DriverId");
        }
