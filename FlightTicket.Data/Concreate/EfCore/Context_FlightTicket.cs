...
{
    public class Context_FlightTicket : DbContext
    {
        public Context_FlightTicket(DbContextOptions<Context_FlightTicket> options) : base(options)
        {
        ...
        public DbSet<Flight> Flightes { get; set; } = null!;


        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
 modelBuilder.Entity<Flight>().HasData(
                new Flight() { Id = 1, Capacity = 12, HasWifi = true },

                 new Flight() { Id = 2, Capacity = 16, HasUSB = true },

                 new Flight() { Id = 3, Capacity = 20, HasWifi = true, HasSeatScreen = true, HasUSB = true }
            );
            ...
            modelBuilder.Entity<Trip>().HasData(
                new Trip() { Id = 1, MidLineId = 1, TripDetailId = 1, FareAmount = 50, ScheduleDate = "01.11.2023", DepartureTime = "11:30", ArrivalTime = "14:00" },
                new Trip() { Id = 2, MidLineId = 2, TripDetailId = 1, ScheduleDate = "01.11.2023", DepartureTime = "14:00", ArrivalTime = "15:20" },
                new Trip() { Id = 3, MidLineId = 3, TripDetailId = 1, FareAmount = 120, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" },
                new Trip() { Id = 4, MidLineId = 4, TripDetailId = 1, FareAmount = 150, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" },
                 ...
                 new Trip()
                 {
                     ...
                     TripDetailId = 1,
                     FareAmount = 70,
                     ScheduleDate = "01.11.2023",
                     DepartureTime = "15:20",
                     ArrivalTime = "21:30"
                 },
                new Trip() { Id = 6, MidLineId = 6, TripDetailId = 2, FareAmount = 150, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" },
                new Trip() { Id = 7, MidLineId = 7, TripDetailId = 2, FareAmount = 110, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" },
                new Trip() { Id = 8, MidLineId = 8, TripDetailId = 2, FareAmount = 60, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" },
                new Trip() { Id = 9, MidLineId = 9, TripDetailId = 2, FareAmount = 90, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" },

                  new Trip() { Id = 10, MidLineId = 10, TripDetailId = 3, FareAmount = 40, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" },
                new Trip() { Id = 11, MidLineId = 11, TripDetailId = 3, FareAmount = 75, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" },
                new Trip() { Id = 12, MidLineId = 12, TripDetailId = 3, FareAmount = 115, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" },
                new Trip() { Id = 13, MidLineId = 13, TripDetailId = 3, FareAmount = 120, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" },
                new Trip() { Id = 14, MidLineId = 14, TripDetailId = 3, FareAmount = 60, ScheduleDate = "01.11.2023", DepartureTime = "15:20", ArrivalTime = "21:30" }
                );

            modelBuilder.Entity<TripDetail>().HasData(
              new TripDetail() { Id = 1, FlightId = 1, DriverId = 1 },
              new TripDetail() { Id = 2, FlightId = 1, DriverId = 1 },
              new TripDetail() { Id = 3, FlightId = 1, DriverId = 1 }
              );
